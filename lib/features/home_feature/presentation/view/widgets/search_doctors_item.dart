...
class SearchDoctorsItem extends StatelessWidget {
  const SearchDoctorsItem({Key? key, required this.doctorItem})
      : super(key: key);

  final Result doctorItem;
  @override
          ...
          Row(
            children: [
              Container(
                ...
                child: Image(
                  image: NetworkImage(doctorItem.image ??
              ...
              Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(
                        'Dr.${doctorItem.name ?? 'Fillerup Grab'}',
                  ...
                  Text(
                    doctorItem.jobTitle ?? 'Tooths Dentist',
                  ...
                  Text(
                    '${doctorItem.experience ?? '7'} Years experience ',
                    style: TextStyles.titleStyle12.copyWith(
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        '74%',
                        style: TextStyles.titleStyle10.copyWith(
                            color: ColorManager.lightGrey,
                            fontWeight: FontWeight.w300),
                      ),
                      SizedBox(
              ...
              Column(
                ...
                children: [
                  Text(
                    'Next Available ',
                    style: TextStyles.titleStyle12.copyWith(
                        fontWeight: FontWeight.w500, color: ColorManager.green),
                    overflow: TextOverflow.ellipsis,
                  ),
                  SizedBox(
                    height: 1.h,
