...
class PinCodeWidget extends StatefulWidget {
  ...
  var onComplete;
  bool isTrueCode;
  PinCodeWidget({Key? key,required this.pinController,required this.onComplete,required this.isTrueCode}) : super(key: key);
...
class _PinCodeWidgetState extends State<PinCodeWidget> {
  ...
  Widget build(BuildContext context) {
    return PinCodeTextField(
      ...
      textStyle: TextStyle(color:  ColorManager.green, ),
